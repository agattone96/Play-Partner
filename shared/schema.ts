...
export const TAG_GROUP_OPTIONS = ["Vibe", "Logistics", "Risk", "Admin"] as const;
...
export const partnerIntimacyRelations = relations(partnerIntimacy, ({ one }) => ({
...
export const partnerLogisticsRelations = relations(partnerLogistics, ({ one }) => ({
  partner: one(partners, {
...
export const adminAssessmentsRelations = relations(adminAssessments, ({ one }) => ({
  partner: one(partners, {
...
export const insertPartnerIntimacySchema = createInsertSchema(partnerIntimacy).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertPartnerLogisticsSchema = createInsertSchema(partnerLogistics).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertAdminAssessmentSchema = createInsertSchema(adminAssessments).omit({
  id: true,
  createdAt: true,
});
...
export type InsertPartnerLogistics = z.infer<typeof insertPartnerLogisticsSchema>;
